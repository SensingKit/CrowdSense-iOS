...
//  SensingKit-iOS
//
//  Created by Kleomenis Katevas on 10/09/2015.
...
+ (void)drawRoundButtonFilledWithTitle: (NSString*)title
{
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(4, 4, 65, 65)];
    [SKStyles.backgroundColor setFill];
    [ovalPath fill];


    //// Text Drawing
    CGRect textRect = CGRectMake(0, 26, 72, 21);
...
+ (void)drawRoundButtonStrokedDeactivatedWithTitle: (NSString*)title
{
    ...
    //// Color Declarations
    UIColor* deactivatedColor = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.558];
